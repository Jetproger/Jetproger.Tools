...
namespace Jetproger.Tools.Convert.Bases
{
    public static partial class ConvertExtensions
    {
        ...
        public static byte? AsByteNull(this object value)
        {
            return value != null ? AsByte(value) : (byte?)null;
        }

        public static sbyte? AsSbyteNull(this object value)
        {
            return value != null ? AsSbyte(value) : (sbyte?)null;
        }

        public static char? AsCharNull(this object value)
        {
            return value != null ? AsChar(value) : (char?)null;
        }

        public static short? AsShortNull(this object value)
        {
            return value != null ? AsShort(value) : (short?)null;
        }

        public static ushort? AsUshortNull(this object value)
        {
            return value != null ? AsUshort(value) : (ushort?)null;
        }

        public static int? AsIntNull(this object value)
        {
            return value != null ? AsInt(value) : (int?)null;
        }

        public static uint? AsUintNull(this object value)
        {
            return value != null ? AsUint(value) : (uint?)null;
        }

        public static long? AsLongNull(this object value)
        {
            return value != null ? AsLong(value) : (long?)null;
        }

        public static ulong? AsUlongNull(this object value)
        {
            return value != null ? AsUlong(value) : (ulong?)null;
        }

        public static Guid? AsGuidNull(this object value)
        {
            return value != null ? AsGuid(value) : (Guid?)null;
        }

        public static float? AsFloatNull(this object value)
        {
            return value != null ? AsFloat(value) : (float?)null;
        }

        public static decimal? AsDecimalNull(this object value)
        {
            return value != null ? AsDecimal(value) : (decimal?)null;
        }

        public static double? AsDoubleNull(this object value)
        {
            return value != null ? AsDouble(value) : (double?)null;
        }

        public static DateTime? AsDateTimeNull(this object value)
        {
        ...
        public static DateTime AsDateTimeMin(this object value)
        {
            var date = AsDateTime(value);
            return date >= MinDate && date <= MaxDate ? date : MinDate;
        }

        public static DateTime AsDateTimeMax(this object value)
        {
            var date = AsDateTime(value);
        ...
        public static char[] AsChars(this object value)
        {
            var stringValue = value.AsString();
            return stringValue != default(string) ? stringValue.ToCharArray() : default(char[]);
        }

        public static string AsString(this DateTime value, string format)
        {
            return value.ToString(format, Formatter);
        }

        public static string AsString(this decimal value, string format)
        {
            return value.ToString(format, Formatter);
        }

        public static string AsString(this double value, string format)
        {
            return value.ToString(format, Formatter);
        }

        public static string AsString(this float value, string format)
        {
            return value.ToString(format, Formatter);
        }
        ...
        public static string AsSql(this object value)
        {
            ...
            var stringValue = value.AsString();
            if (value is string || value is DateTime || value is char || value is char[]) stringValue = $"'{stringValue.Replace("'", "''").Replace("%", "%%")}'"; else

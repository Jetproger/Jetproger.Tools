...
namespace Jetproger.Tools.Convert.Factories
{
    public class IpcClient
    {
        ...
        {
            var creator = new ParamCreator(func);
        ...
        private bool TryOfToStoreCombain(Type keyType, Type valueType, object key, ParamCreator creator, out object value)
        {
        ...
        private bool TryOfToStoreContainer(Type keyType, Type valueType, object key, ParamCreator creator, out object value)
        {
            try
            {
        ...
        private object TryOfToStoreLocal(Type keyType, Type valueType, object key, ParamCreator creator)
        {
        ...
        {
            return f.sys.isapp(); //return AppDomain.CurrentDomain.IsDefaultAppDomain() || f.own == null;
        }
    }
    ...
    public class IpcServer : MarshalByRefObject
    {
        ...
        public object OfToOne(Type type, SimpleCreator creator) { return OneExtensions.GetSet(type, creator); }
        public object OfOne(Type type) { return OneExtensions.Get(type); }
        public void ToOne(Type type, object value) { OneExtensions.Set(type, value); }
        public object OfToPool(Type type, SimpleCreator creator) { return PoolExtensions.GetSet(type, creator); }
        public object OfPool(Type type) { return PoolExtensions.Get(type); }
        public void ToPool(Type type, object value) { PoolExtensions.Set(type, value); }
        public object OfToStore(Type keyType, Type valueType, object key, ParamCreator creator) { return StoreExtensions.GetSet(keyType, valueType, key, creator); }
        public object OfStore(Type keyType, Type valueType, object key) { return StoreExtensions.Get(keyType, valueType, key); }
        public void ToStore(Type keyType, Type valueType, object key, object value) { StoreExtensions.Set(keyType, valueType, key, value); }
